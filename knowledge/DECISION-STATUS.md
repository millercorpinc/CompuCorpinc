...
The repository is not a blank business-design exercise. Established Startup-project directions are the presumptive operating design. Formal approval may still be required, but contributors should not reopen them without evidence of a contradiction, risk, or explicit founder request.
...
| Market segmentation research | Developed hypothesis | Chicago research supports retaining the core employer ICP while testing smaller high-value professional/regulated firms using economic/risk/technology intensity rather than headcount alone | Execute 30–40 structured interviews and 3-digit NAICS/account-data plan before approving changes |
| Microbusiness opportunity | Research hypothesis | Serious owner-operated/1–4-user firms may support a separate productized security/continuity baseline; not a smaller copy of the full Foundation | Validate receipt/risk thresholds, price, CAC, delivery hours, support burden, and channel economics before launch |
| Vertical focus | Open market decision | Accounting/tax, legal, healthcare, and construction/field/property remain parallel Chicago validation tracks; finance/insurance, architecture/engineering, and nonprofits are secondary research markets | Compare close rate, margin, repeatability, recurring attach, risk, and referral density before selecting a preferred vertical |
...
| Go-to-market | Established baseline | Founder-led warm network, focused offers, pilots, case studies, referrals | Execute and measure; add public-registry/association data and trigger-led experiments |
| Competitive posture | Developed hypothesis | Avoid generic MSP positioning; test assessment/remediation coexistence, “supported but not architected,” evidence-oriented security, and security + workflow modernization | Validate through incumbent interviews, real proposals, and win/loss data |
